  ...
  public ArticleDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfArticle = new EntityInsertionAdapter<Article>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `article` (`id`,`author`,`content`,`description`,`publishedAt`,`source`,`title`,`url`,`urlToImage`) VALUES (?,?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Article value) {
        ...
        final String _tmp;
        _tmp = __convertors.fromSource(value.getSource());
        if (_tmp == null) {
          stmt.bindNull(6);
        } else {
      ...
      public List<Article> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _tmpSource = __convertors.toSource(_tmp);
